...
let meal = {
  ...
  description:
    "A typical cypriot breakfast that consists of toasted bread and fresh vegetables on the side.",
  image: "images/cypriotBreakfast.jpeg",
  stars: "4",
  timeToCook: "10mins",
  price: "8",
  dishDescription:
    "A very simple yet tasty breakfast that almost everyone eats in Cyprus. It consists of toasted bread  with butter accompanied by fresh tomatoes,cucumbers and olives as well as slices of ham and cheese or hallumi.",
  ingredients: [
    "bread",
    "butter",
    "tomatoes",
  ...
  serveWith: ["halloumi cheese", "Yogurt to compliment the bread"],
  howTo:
    "Toast the bread, add all your favourite vegetables, make some tea or coffee and enjoy a simple and delicous traditional cypriot braekfast.",
  hidden: false,
};
...
let meal4 = {
  ...
  name: "Koupepia",
  description:
    "Koupepia are stuffed vine leaves with meat are very popular in Cyprus.",
  image: "images/koupepia.jpeg",
  stars: "5",
  timeToCook: "1hr",
  price: "20",
  dishDescription:
    "This famous dish Koupepia are delicious rolls of meat covered by grape leaves served with greek yogurt. ",
  ingredients: [
...
let meal7 = {
  ...
  name: "Avgolemoni",
  description:
    "A traditional cyprtiot soup served in the winter and during Easter.",
  image: "images/avgolemoni.jpg",
  stars: "5",
  timeToCook: "1hr 30min ",
  price: 15,
  dishDescription:
    "This soup is created with eggs,lemon and rice, 3 ingredients combined together creating a delicious flavour.",
  ingredients: ["4 eggs", "3 lemons", "2 tbs salt", "300g rice", "chicken"],
  serveWith:
...
let meal10 = {
  ...
  name: "Loukoumades",
  description:
    "Loukoumades are little fluffy sweet honey balls, deep fried to golden and crispy perfection.",
  ...
  serveWith: ["These cypriot donuts are perfect with a cypriot cup of coffe."],
  howTo: [
...
function updateSummary() {
  ...
  if (cartMeal != null) {
    ...
    summaryOrderInfo.style.display = "none";
  }
}
